                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            NumberButton(number: 0, text: "участников", func: (){},),
                            NumberButton(number: 0, text: "персонажей", func: (){},),
                            NumberButton(
                                number: 0, text: "персонажей занято", func: (){},),
                            NumberButton(number: 0, text: "аудиодорожек", func: (){},),
                          ],
                        ),
                        const StriderDivider(),
                        SizedBox(
